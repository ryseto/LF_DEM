			...
			if (j > i) {
				...
				switch (lubrication_model) {
					...
					case 2:
						...
						// stokes_solver.addToDiagBlock(nr_vec, i, 0,
						// 							 0, (*it)->get_scaled_YB0(), 0);
						// stokes_solver.addToDiagBlock(nr_vec, j, 0,
						// 							 0, (*it)->get_scaled_YB3(), 0);
						// // double scaledXA, double YA, , double scaledYB, double scaledYBtilde, double scaledYC
						// stokes_solver.setOffDiagBlock(nr_vec, i, j, 0, 
                        //                              0, (*it)->get_scaled_YB1(), (*it)->get_scaled_YB2(), 0);
